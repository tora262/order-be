...
import tech.tora.app.OrderbeApp;
import tech.tora.app.config.AsyncSyncConfiguration;
import tech.tora.app.config.EmbeddedMongo;
...
@SpringBootTest(classes = { OrderbeApp.class, AsyncSyncConfiguration.class })
@EmbeddedMongo
