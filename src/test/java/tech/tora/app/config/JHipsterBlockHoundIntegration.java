...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("tech.tora.app.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("tech.tora.app.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
